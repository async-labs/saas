...
function get(name, required, alternateName) {
    if (required === void 0) { required = false; }
    if (alternateName === void 0) { alternateName = null; }
    var val = process.env[name] || null;
    if (!val && required) {
...
exports.IS_DEV = exports.NODE_ENV !== 'production';
exports.PORT_API = +get('PORT') || 8000;
exports.PORT_APP = +get('APP_PORT') || 3000;
var urlAPI = get('URL_API');
if (!urlAPI) {
    urlAPI = exports.IS_DEV ? get('DEVELOPMENT_URL_API') || "http://localhost:" + exports.PORT_API : get('PRODUCTION_URL_API', true, 'URL_API');
}
exports.URL_API = urlAPI;
var urlAPP = get('URL_APP');
if (!urlAPP) {
    urlAPP = exports.IS_DEV ? get('DEVELOPMENT_URL_APP') || "http://localhost:" + exports.PORT_APP : get('PRODUCTION_URL_APP', true, 'URL_APP');
}
exports.URL_APP = urlAPP;
// 6
